    ...
    %{
      ...
      metadata: %{
        labels: %{
          ...
          "app.kubernetes.io/version": Application.fetch_env!(:nydus_operator, :version),
      ...
      template: %{
        metadata: %{
          annotations: %{
            ...
            "nydus.mrchypark.github.io/enabled": "true",
            "nydus.mrchypark.github.io/debug": "false"
            }
          },
          spec: %{
            securityContext: %{
